...
\begin{figure} % 特に強い理由がない限り、[htbp]のような指定はしないでください。
  ...
  \includegraphics[width=14cm]{figQAQC/CTA.jpg}
...
\begin{figure}
  \centering
  \includegraphics[width=10cm]{figQAQC/TB3.png}
...
\begin{figure}
  \centering
  % PDFも使えます。
  \includegraphics[width=14cm]{figQAQC/histogram.pdf}
...
\begin{figure}
  ...
  \subfigure[]{% {の直後に%を置くことで、改行をさせない（図(b)を改行させない）。
    \includegraphics[width=.5\textwidth,clip]{figQAQC/histogram.pdf}%
...
\begin{figure}
  \begin{minipage}[b]{.3333\linewidth}
    \leftline{(a)}
    \centering
    \includegraphics[width=\columnwidth]{figQAQC/histogram.pdf}
  \end{minipage}%
  \begin{minipage}[b]{.3333\linewidth}
    \leftline{(b)}
    \centering
    \includegraphics[width=\columnwidth]{figQAQC/histogram_png.png}
  \end{minipage}%
  \begin{minipage}[b]{.3333\linewidth}
    \leftline{(c)}
    \centering
    \includegraphics[width=\columnwidth]{figQAQC/histogram_jpg.jpg}
  \end{minipage}
