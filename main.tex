...
\captionsetup[table]{  % figure でも同じ
  width=.9\linewidth,format=plain, labelformat=simple,
  skip=0pt, labelsep=quad,labelfont=normal
}
\captionsetup[figure]{  % figure でも同じ
  width=.9\linewidth, format=plain, labelformat=simple,
  skip=0pt, labelsep=quad,labelfont=normal
}
...
% \include{2.Review}
% \include{3-1.WhatYouDid}
\include{3-2.WhatYouDid}
% \include{3-3.WhatYouDid}
% \include{4.LaTeX}
% \include{5.Plagiarism}
% \include{6.Color}
